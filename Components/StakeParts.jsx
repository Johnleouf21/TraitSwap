...
const StakeParts = (props) =>{
    ...
    return(
        <div>
            <div id='eggs'>
                <img alt="" className="partsHolder selected" src={tamagoURL+props.mintedTamago+'.png'}/>
            </div>
            <div id='tamago' style={{width:'100%',height:'250px',display:'flex',justifyContent:'center'}}>
                <img alt="" className='eggHolder' src={tamagoURL+props.mintedTamago+'.png'}/>
                <img alt="" className='eggHolder' src={part1}/>
                <img alt="" className='eggHolder' src={part2}/>
                <img alt="" className='eggHolder' src={part3}/>
                <img alt="" className='eggHolder' src={part4}/>
                <img alt="" className='eggHolder' src={part5}/>
                <img alt="" className='eggHolder' src={part6}/>
                <img alt="" className='eggHolder' src={part7}/>
                <img alt="" className='eggHolder' src={part8}/>
            ...
            <div id='partsDiv'>
            {
                Object.entries(minted).slice(0,4).map((value,key)=>{
                    ...
                    <div style={{display:'inline-block'}}>
                                <>
                                <img alt="" name={value[0]} className="partsHolder" src={value[1][0]} onClick={(e)=>{partClick(value[0],value[1][0],e)}}/>
